 ...
 */
public class CursoGE extends javax.swing.JFrame {

    /**
     * Creates new form CursoGE
     */
    public CursoGE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestão de Equipes");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(240, 50, 110, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CursoGE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
